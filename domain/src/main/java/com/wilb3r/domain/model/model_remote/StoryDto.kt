...
data class StoryDto(
    ...
    @field:Json(name = "created_date") val createdDate: Date? = null,
    ...
    @field:Json(name = "published_date") val publishedDate: Date? = null,
    ...
    @field:Json(name = "updated_date") val updatedDate: Date? = null,
